...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'hillyu']
...
registrations = {
    ...
    'microsoft': {
        'authorize_endpoint': 'https://login.microsoftonline.com/ed439e7b-498b-4ff9-83d6-23e6e01abbdb/oauth2/v2.0/authorize',
        'devicecode_endpoint': 'https://login.microsoftonline.com/ed439e7b-498b-4ff9-83d6-23e6e01abbdb/oauth2/v2.0/devicecode',
        'token_endpoint': 'https://login.microsoftonline.com/ed439e7b-498b-4ff9-83d6-23e6e01abbdb/oauth2/v2.0/token',
        'redirect_uri': 'https://login.microsoftonline.com/ed439e7b-498b-4ff9-83d6-23e6e01abbdb/oauth2/nativeclient',
        'tenant': 'common',
        ...
        'client_id': '4fba1e7a-1149-4af1-a09a-dc96d8282b9b',
        'client_secret': '',
    },
}
